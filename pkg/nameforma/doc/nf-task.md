...
| `test` | `manage` | Tests pass or unexpected errors occur. |
...
See `nf --help` for more information.

## Workflow Guide for Agents

- work on one action at a time
- think twice before talking
- talk and agree before acting
- verify after acting
- update action status as you work
- follow the state diagram
- restrict implementation to changes that are directly related to current action
