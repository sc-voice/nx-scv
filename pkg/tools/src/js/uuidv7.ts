...
class UUIDV7 {
   ...
   *
   * @returns UUID in format: 019cc8b2-e91e-7000-8669-15ac4a704757
   */
   ...
   * @returns -1, 0, or 1
   */
  static compare(a: string | Buffer, b: string | Buffer): number {
   ...
   * @returns boolean
   */
  static isLessThan(a: string | Buffer, b: string | Buffer): boolean {
   ...
   * @returns boolean
   */
  static isGreaterThan(a: string | Buffer, b: string | Buffer): boolean {
    return UUIDV7.compare(a, b) > 0;
  }
}
 ...
 * @returns 16 bytes
 */
function uuidStringToBytes(uuidString: string): Buffer {
