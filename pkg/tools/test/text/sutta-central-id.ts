...
typeof describe === 'function' &&
  describe('text/sutta-central-id', function () {
    ...
    const assertLess = (cmp: (a: string, b: string) => number, a: string, b: string) => {
      expect(cmp(a, b)).toBeLessThan(0);
      expect(cmp(b, a)).toBeGreaterThan(0);
    };
    const assertEqual = (cmp: (a: string, b: string) => number, a: string, b: string) => {
      expect(cmp(a, b)).toBe(0);
      expect(cmp(b, a)).toBe(0);
    };
    function testCompareLow(a: string, b: string, expected: number) {
    ...
    it('rangeHigh => upper bound MIL', () => {
      expect(SuttaCentralId.rangeHigh('mil3.1.2--mil3.1.9')).toBe(
        'mil3.1.9',
      );
    });
    ...
    it('compareLow(a,b) compares sutta file names', () => {
      ...
      expect(cmp('sn/en/sujato/sn29.1', 'sn/en/sujato/sn29.11-20')).toBe(
        -10,
      );
      expect(cmp('sn/en/sujato/sn29.11-20', 'sn/en/sujato/sn29.1')).toBe(
        10,
      );
      expect(cmp('sn/en/sujato/sn29.10', 'sn/en/sujato/sn29.11-20')).toBe(
        -1,
      );
      expect(cmp('sn/en/sujato/sn29.11-20', 'sn/en/sujato/sn29.10')).toBe(
        1,
      );
