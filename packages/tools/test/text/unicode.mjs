...
describe('text/unicode', () => {
  ...
  it('romanize(text) returns romanized text', () => {
    ...
    expect(u.EMPTY_SET).toBe('\u2205');
    expect(u.ELEMENT_OF).toBe('\u2208');
    expect(u.IMPLIES).toBe('\u21D2');
  ...
  it('romanize(text) returns romanized text', () => {
    ...
    expect(u.romanize('tassā’ti')).toBe(`tassa${Unicode.RSQUOTE}ti`);
    ...
    expect(u.romanize('‘Nandī dukkhassa mūlan’ti—')).toBe(
      `${Unicode.LSQUOTE}` +
